    ...
    <div className="min-h-full p-6 lg:p-8">
      <div className="mx-auto max-w-2xl">
        <div className="mb-8">
          ...
          <p className="mt-1 text-sm text-white/40">Passe Clyven nach deinen Wünschen an.</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
            ...
            <p className="mb-1 text-sm font-medium text-white/70">Erscheinungsbild</p>
            <p className="mb-4 text-xs text-white/30">Wähle zwischen Dark und Light Mode.</p>
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }}
            ...
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-sm font-medium text-white/70">Tägliches Fokusziel</p>
            </div>
            <p className="mb-4 text-xs text-white/30">Wie viele Minuten Fokuszeit möchtest du täglich erreichen?</p>
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-sm font-medium text-white/70">Benachrichtigungen</p>
                  <p className="text-xs text-white/30">Focus-Session Erinnerungen</p>
                </div>
              </div>
          ...
          <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={save}
            ...
            {saved ? <><Check className="h-4 w-4" /> Gespeichert!</> : <><Save className="h-4 w-4" /> Einstellungen speichern</>}
          </motion.button>
